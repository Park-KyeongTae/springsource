...
public class RestControllerTest {
	...
	// 일반 컨트롤러에서 return 값은 view 이름 (jsp파일)
	...
	public List<SampleDTO> sendList() {
		...
		list.add(new SampleDTO("1235", "김", "길동"));
		list.add(new SampleDTO("1236", "이", "길동"));
		list.add(new SampleDTO("1237", "박", "길동"));
	...
	// http://localhost:8080/product/shirt/1003 : bags(카테고리명), 1001(상품아이디)
