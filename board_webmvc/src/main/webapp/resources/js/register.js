...
form.addEventListener("submit", (e) => {
  ...
  if (!form.checkValidity()) {
    ...
    lis.forEach((ele, idx) => {
      ...
      // li 하나당
      // <input type='hidden' name='attachList[0].uuid' value='e32c6faf-4ae9-4bdf-8b54-f84709460ee8'/>
      // <input type='hidden' name='attachList[0].uploadPath' value='2023/05/30'/>
      // <input type='hidden' name='attachList[0].fileName' value=' 웰시코기.jpg'/>
